...
from model.pelicula_dao import crear_tabla, borrar_tabla, listar, editar, eliminar, guardar
...
class Frame(tk.Frame):
    ...
    def campos_peliculas(self):
        ...
        self.entry_nombre.config(width=50,  font=('Arial',))
        self.entry_nombre.grid(row=0, column=1, padx='10',
                               pady='10', columnspan='2')

        self.mi_duracion = tk.StringVar()
        self.entry_duracion = tk.Entry(self, textvariable=self.mi_duracion)
        self.entry_duracion.config(width=50,  font=('Arial',))
        self.entry_duracion.grid(
            row=1, column=1, padx='10', pady='10', columnspan='2')

        self.mi_genero = tk.StringVar()
        self.entry_genero = tk.Entry(self, textvariable=self.mi_genero)
        self.entry_genero.config(width=50,  font=('Arial',))
        self.entry_genero.grid(row=2, column=1, padx='10',
                               pady='10', columnspan='2')
        ...
        self.boton_guardar.config(width=20, font=('Arial', 12, 'bold'),
                                  fg="#DAD5D6", bg="#1658A2", cursor='hand2', activebackground='#1658A9')
    ...
    def tabla_peliculas(self):
        ...
        # Scrollbar de la tabla_peliculas
        ...
        self.boton_canc = tk.Button(
            self, text='Eliminar', command=self.eliminar_datos)
        self.boton_canc.config(width=20, font=('Arial', 12, 'bold'),
                               fg="#DAD5D6", bg="#BD152E", cursor='hand2', activebackground='#E15370')
        self.boton_canc.grid(row=6, column=1, padx='10', pady='10')
    ...
    def editar_datos(self):
        try:
            ...
            print(self.id_pelicula, self.nombre_pelicula,
                  self.duracion_pelicula, self.genero_pelicula)
